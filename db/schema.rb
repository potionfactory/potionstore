...
ActiveRecord::Schema.define(:version => 1) do
  ...
  add_foreign_key_constraint "line_items", "order_id", "orders", "id", :name => "line_items_ibfk_order_id", :on_update => nil, :on_delete => :cascade
  add_foreign_key_constraint "line_items", "product_id", "products", "id", :name => "line_items_ibfk_product_id", :on_update => nil, :on_delete => nil

  add_foreign_key_constraint "orders", "coupon_id", "coupons", "id", :name => "orders_ibfk_coupon_id", :on_update => nil, :on_delete => :restrict
